...
//    /**
//     * INI DI MODIFIKASI....
//     * di modif -> classesToProcessForMappedSuperclass.add( 0, currentClassInHierarchy );
//     * menjadi classesToProcessForMappedSuperclass.add(currentClassInHierarchy );
//     */
//
//
...
//    /**
//     * INI DI MODIFIKASI....
//     * di modif ->for ( int index = 0; index < lastMappedSuperclass; index++ ) {
//     * menjadi for ( int index = lastMappedSuperclass; index > 0; index-- ) {
//     */
